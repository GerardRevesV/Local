...
- [ ] ✅ **Repartits el 24/09/2026 a les 13:46, en posicions de prova, i marcador apagat a les
      ...
      el nom de [noms-entitats.md](domotica/noms-entitats.md), que és d'on els llegeix —no del
      tauler, com `comprova.sh`—, i cap no pot tenir un `…_2` al costat. Vol dir que **el calibratge ha d'estar desplegat** abans: sense,
...
- [x] ~~**Decidir on viu la lògica de control** del punt de rosada.~~ ✅ **HA natiu**, i ja
      **escrita**: `config/packages/rosada.yaml` (637 línies), amb un únic punt d'avaluació,
