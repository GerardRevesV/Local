...
- *Ja escrits (**~1.900 línies**):* `packages/rosada.yaml` (**577**), `scripts/comprova.sh` (288), `tools/replica.py` (276), `scripts/prepara-host.sh` (270), `scripts/inicia-serie.sh` (167), `docker-compose.yml` (**149**), `tools/valida_yaml.py` (100), `config/configuration.yaml` (71).
