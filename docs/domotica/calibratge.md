...
3. Comprovar que **existeixen les deu entitats noves** amb el nom exacte —
   ...
   si en surt alguna amb `_2` al final, s'ha de renombrar **abans** que gravi res (`inicia-serie.sh`
   torna a buscar les calibrades —no els `_cru`— i s'hi nega, però els dies d'experimentació ja
   haurien gravat a la que no toca)— i que **l'atribut
