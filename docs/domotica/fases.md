...
| A.11 | Compte de healthchecks.io i els dos checks. 🔁 ***21/09/2026:*** `scripts/bategada.sh` (141 línies) **escrit**, amb el cos sortint de `comprova.sh --breu`; falten el compte, el desplegament i la prova del correu. El check `nit` espera `nit.py` (A.9) → [runbook](runbook-servidor.md#lavís-de-caiguda--healthchecksio) | 👤 Tu el compte i els checks, 🤖 jo el guió |
