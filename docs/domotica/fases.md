...
| B.7 | ✅ **Fet** — `tools/replica.py` (1088 línies): rèplica offline de la lògica i test de deriva contra el que va registrar el sensor. *(22/09/2026: rèplica de la v2, amb `--prova-ha`, que compara la macro avaluada per HA, i `--deriva`, que torna a decidir cada fila gravada)* | 🤖 Jo |
